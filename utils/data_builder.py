...
class DataBuilder(object):
    ...
    def build_dataset(self):
        ...
        return {'dev': {'dev_customer': dev_customer,
                        'dev_contract_previous': dev_contract_previous,
                        'dev_contract_target': dev_contract_target},
                'oot': {'oot_customer': oot_customer,
                        'oot_contract_previous': oot_contract_previous,
                        'oot_contract_target': oot_contract_target}}
